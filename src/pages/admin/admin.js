    ...
    <Container>
		<Row className="justify-content-center">
			<Col xs={10} className="d-flex justify-content-between">
				...
				<div className="d-flex align-items-center" style={{cursor:"pointer"}} onClick={handleClickLogout}>   
     ...
     <Container>
       <Row className="justify-content-center">
         ...
         <Col xs={10}>
			 ...
			 <div onClick={handleClickCreateRole} style={{cursor:"pointer"}} className="d-inline">
