  ...
  return (
	...
	*/}
	...
	<Row className="justify-content-center ps-3 pe-3 mt-1">
	  ...
	  {form["supervisorName"] === "" &&
	  <Col xs={5} className="border border-dark rounded" style={{padding:"0"}}>
		 <Form.Select value={nameOfSupervisor} onChange={handleNameOfSupervisor} style={{padding:"12px"}} aria-label="Default select example">
	...
	<Row className="justify-content-center">
		<Col xs={5} className="d-grid">
			<Button type="submit" variant="dark">Approve</Button>
		</Col>
	</Row>
	}
