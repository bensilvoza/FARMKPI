...
function EditForm() {
  ...
  var bbTotalSamples =
    Number(bbTotalSamplesQ1) +
    Number(bbTotalSamplesQ2) +
    Number(bbTotalSamplesQ3) +
    Number(bbTotalSamplesQ4);
  ...
  var bbLateInstallation =
    (1 -
      (Number(bbLateInstallationQ1) +
        Number(bbLateInstallationQ2) +
        Number(bbLateInstallationQ3) +
        Number(bbLateInstallationQ4)) /
        bbTotalSamples) *
    25;
  ...
  var bbLateRetrieval =
    (1 -
      (Number(bbLateRetrievalQ1) +
        Number(bbLateRetrievalQ2) +
        Number(bbLateRetrievalQ3) +
        Number(bbLateRetrievalQ4)) /
        bbTotalSamples) *
    30;
  ...
  var bbImproperInstall =
    (1 -
      (Number(bbImproperInstallQ1) +
        Number(bbImproperInstallQ2) +
        Number(bbImproperInstallQ3) +
        Number(bbImproperInstallQ4)) /
        bbTotalSamples) *
    10;
  ...
  var bbNoMarking =
    (1 -
      (Number(bbNoMarkingQ1) +
        Number(bbNoMarkingQ2) +
        Number(bbNoMarkingQ3) +
        Number(bbNoMarkingQ4)) /
        bbTotalSamples) *
    10;
  ...
  var pgTotalSamples =
    Number(pgTotalSamplesQ1) +
    Number(pgTotalSamplesQ2) +
    Number(pgTotalSamplesQ3) +
    Number(pgTotalSamplesQ4);
  ...
  var bsTotalSamples =
    Number(bsTotalSamplesQ1) +
    Number(bsTotalSamplesQ2) +
    Number(bsTotalSamplesQ3) +
    Number(bsTotalSamplesQ4);
  ...
  var bsUndercycle =
    (1 -
      (Number(bsUndercycleQ1) +
        Number(bsUndercycleQ2) +
        Number(bsUndercycleQ3) +
        Number(bsUndercycleQ4)) /
        bsTotalSamples) *
    40;
  ...
  var fddoTotalSamples =
    Number(fddoTotalSamplesQ1) +
    Number(fddoTotalSamplesQ2) +
    Number(fddoTotalSamplesQ3) +
    Number(fddoTotalSamplesQ4);
  ...
  var fddoLateFirst =
    (1 -
      (Number(fddoLateFirstQ1) +
        Number(fddoLateFirstQ2) +
        Number(fddoLateFirstQ3) +
        Number(fddoLateFirstQ4)) /
        fddoTotalSamples) *
    10;
  ...
  var fddoLateFinal =
    (1 -
      (Number(fddoLateFinalQ1) +
        Number(fddoLateFinalQ2) +
        Number(fddoLateFinalQ3) +
        Number(fddoLateFinalQ4)) /
        fddoTotalSamples) *
    10;
  ...
  var fddoImproper =
    (1 -
      (Number(fddoImproperQ1) +
        Number(fddoImproperQ2) +
        Number(fddoImproperQ3) +
        Number(fddoImproperQ4)) /
        fddoTotalSamples) *
    10;
  ...
  var fddoExtreme =
    (1 -
      (Number(fddoExtremeQ1) +
        Number(fddoExtremeQ2) +
        Number(fddoExtremeQ3) +
        Number(fddoExtremeQ4)) /
        fddoTotalSamples) *
    10;
  ...
  var fddoMissout =
    (1 -
      (Number(fddoMissoutQ1) +
        Number(fddoMissoutQ2) +
        Number(fddoMissoutQ3) +
        Number(fddoMissoutQ4)) /
        fddoTotalSamples) *
    5;
  ...
  var fddoLate3to5 =
    (1 -
      (Number(fddoLate3to5Q1) +
        Number(fddoLate3to5Q2) +
        Number(fddoLate3to5Q3) +
        Number(fddoLate3to5Q4)) /
        fddoTotalSamples) *
    10;
  ...
  var fddoNonFollowing =
    (1 -
      (Number(fddoNonFollowingQ1) +
        Number(fddoNonFollowingQ2) +
        Number(fddoNonFollowingQ3) +
        Number(fddoNonFollowingQ4)) /
        fddoTotalSamples) *
    10;
  ...
  var bskTotalSamples =
    Number(bskTotalSamplesQ1) +
    Number(bskTotalSamplesQ2) +
    Number(bskTotalSamplesQ3) +
    Number(bskTotalSamplesQ4);
  ...
  var bskNoPlastic =
    (1 -
      (Number(bskNoPlasticQ1) +
        Number(bskNoPlasticQ2) +
        Number(bskNoPlasticQ3) +
        Number(bskNoPlasticQ4)) /
        bskTotalSamples) *
    10;
  ...
  var bskImproper =
    (1 -
      (Number(bskImproperQ1) +
        Number(bskImproperQ2) +
        Number(bskImproperQ3) +
        Number(bskImproperQ4)) /
        bskTotalSamples) *
    5;
  ...
  var bskIncomplete =
    (1 -
      (Number(bskIncompleteQ1) +
        Number(bskIncompleteQ2) +
        Number(bskIncompleteQ3) +
        Number(bskIncompleteQ4)) /
        bskTotalSamples) *
    5;
  ...
  var bskNoSunburn =
    (1 -
      (Number(bskNoSunburnQ1) +
        Number(bskNoSunburnQ2) +
        Number(bskNoSunburnQ3) +
        Number(bskNoSunburnQ4)) /
        bskTotalSamples) *
    25;
  // ===========
  // END, BAGSOK
  ...
  var leafTotalSamples =
    Number(leafTotalSamplesQ1) +
    Number(leafTotalSamplesQ2) +
    Number(leafTotalSamplesQ3) +
    Number(leafTotalSamplesQ4);
  ...
  var leafMissout =
    (1 -
      (Number(leafMissoutQ1) +
        Number(leafMissoutQ2) +
        Number(leafMissoutQ3) +
        Number(leafMissoutQ4)) /
        leafTotalSamples) *
    25;
  ...
  async function handleSubmit(e) {
    ...
    var data = {
      ...
      bbLateInstallationQ: [
        bbLateInstallationQ1,
        bbLateInstallationQ2,
        bbLateInstallationQ3,
        bbLateInstallationQ4,
      ],
    ...
    var send = await axios.post(
      "https://farmkpiback.herokuapp.com/evaluator/edit/" + formId,
      data
    );
    if (send["data"] === "Form updated") {
  ...
  useEffect(async function() {
    var getForm = await axios.get(
      "https://farmkpiback.herokuapp.com/evaluator/" + formId
    );
    setFormData(getForm["data"]["form"]);
  }, []);

  useEffect(
    async function() {
      if (formData !== "") {
        setFarm(formData["farm"]);
        setLocation(formData["location"]);
        setDate(formData["date"]);
        setWeek(formData["week"]);

        setbbTotalSamplesQ1(formData["bbTotalSamplesQ"][0]);
        setbbTotalSamplesQ2(formData["bbTotalSamplesQ"][1]);
        setbbTotalSamplesQ3(formData["bbTotalSamplesQ"][2]);
        setbbTotalSamplesQ4(formData["bbTotalSamplesQ"][3]);

        setbbLateInstallationQ1(formData["bbLateInstallationQ"][0]);
        setbbLateInstallationQ2(formData["bbLateInstallationQ"][1]);
        setbbLateInstallationQ3(formData["bbLateInstallationQ"][2]);
        setbbLateInstallationQ4(formData["bbLateInstallationQ"][3]);

        setbbMissOutQ1(formData["bbMissOutQ"][0]);
        setbbMissOutQ2(formData["bbMissOutQ"][1]);
        setbbMissOutQ3(formData["bbMissOutQ"][2]);
        setbbMissOutQ4(formData["bbMissOutQ"][3]);

        setbbLateRetrievalQ1(formData["bbLateRetrievalQ"][0]);
        setbbLateRetrievalQ2(formData["bbLateRetrievalQ"][1]);
        setbbLateRetrievalQ3(formData["bbLateRetrievalQ"][2]);
        setbbLateRetrievalQ4(formData["bbLateRetrievalQ"][3]);

        setbbImproperInstallQ1(formData["bbImproperInstallQ"][0]);
        setbbImproperInstallQ2(formData["bbImproperInstallQ"][1]);
        setbbImproperInstallQ3(formData["bbImproperInstallQ"][2]);
        setbbImproperInstallQ4(formData["bbImproperInstallQ"][3]);

        setbbNoMarkingQ1(formData["bbNoMarkingQ"][0]);
        setbbNoMarkingQ2(formData["bbNoMarkingQ"][1]);
        setbbNoMarkingQ3(formData["bbNoMarkingQ"][2]);
        setbbNoMarkingQ4(formData["bbNoMarkingQ"][3]);

        setpgTotalSamplesQ1(formData["pgTotalSamplesQ"][0]);
        setpgTotalSamplesQ2(formData["pgTotalSamplesQ"][1]);
        setpgTotalSamplesQ3(formData["pgTotalSamplesQ"][2]);
        setpgTotalSamplesQ4(formData["pgTotalSamplesQ"][3]);

        setpgLateQ1(formData["pgLateQ"][0]);
        setpgLateQ2(formData["pgLateQ"][1]);
        setpgLateQ3(formData["pgLateQ"][2]);
        setpgLateQ4(formData["pgLateQ"][3]);

        setpgMissoutQ1(formData["pgMissoutQ"][0]);
        setpgMissoutQ2(formData["pgMissoutQ"][1]);
        setpgMissoutQ3(formData["pgMissoutQ"][2]);
        setpgMissoutQ4(formData["pgMissoutQ"][3]);

        setpgImproperQ1(formData["pgImproperQ"][0]);
        setpgImproperQ2(formData["pgImproperQ"][1]);
        setpgImproperQ3(formData["pgImproperQ"][2]);
        setpgImproperQ4(formData["pgImproperQ"][3]);

        setbsTotalSamplesQ1(formData["bsTotalSamplesQ"][0]);
        setbsTotalSamplesQ2(formData["bsTotalSamplesQ"][1]);
        setbsTotalSamplesQ3(formData["bsTotalSamplesQ"][2]);
        setbsTotalSamplesQ4(formData["bsTotalSamplesQ"][3]);

        setbsMissoutQ1(formData["bsMissoutQ"][0]);
        setbsMissoutQ2(formData["bsMissoutQ"][1]);
        setbsMissoutQ3(formData["bsMissoutQ"][2]);
        setbsMissoutQ4(formData["bsMissoutQ"][3]);

        setbsBunchQ1(formData["bsBunchQ"][0]);
        setbsBunchQ2(formData["bsBunchQ"][1]);
        setbsBunchQ3(formData["bsBunchQ"][2]);
        setbsBunchQ4(formData["bsBunchQ"][3]);

        setbsUndercycleQ1(formData["bsUndercycleQ"][0]);
        setbsUndercycleQ2(formData["bsUndercycleQ"][1]);
        setbsUndercycleQ3(formData["bsUndercycleQ"][2]);
        setbsUndercycleQ4(formData["bsUndercycleQ"][3]);

        setbsNoMarkQ1(formData["bsNoMarkQ"][0]);
        setbsNoMarkQ2(formData["bsNoMarkQ"][1]);
        setbsNoMarkQ3(formData["bsNoMarkQ"][2]);
        setbsNoMarkQ4(formData["bsNoMarkQ"][3]);

        setfddoTotalSamplesQ1(formData["fddoTotalSamplesQ"][0]);
        setfddoTotalSamplesQ2(formData["fddoTotalSamplesQ"][1]);
        setfddoTotalSamplesQ3(formData["fddoTotalSamplesQ"][2]);
        setfddoTotalSamplesQ4(formData["fddoTotalSamplesQ"][3]);

        setfddoLateFirstQ1(formData["fddoLateFirstQ"][0]);
        setfddoLateFirstQ2(formData["fddoLateFirstQ"][1]);
        setfddoLateFirstQ3(formData["fddoLateFirstQ"][2]);
        setfddoLateFirstQ4(formData["fddoLateFirstQ"][3]);

        setfddoLateFinalQ1(formData["fddoLateFinalQ"][0]);
        setfddoLateFinalQ2(formData["fddoLateFinalQ"][1]);
        setfddoLateFinalQ3(formData["fddoLateFinalQ"][2]);
        setfddoLateFinalQ4(formData["fddoLateFinalQ"][3]);

        setfddoImproperQ1(formData["fddoImproperQ"][0]);
        setfddoImproperQ2(formData["fddoImproperQ"][1]);
        setfddoImproperQ3(formData["fddoImproperQ"][2]);
        setfddoImproperQ4(formData["fddoImproperQ"][3]);

        setfddoExtremeQ1(formData["fddoExtremeQ"][0]);
        setfddoExtremeQ2(formData["fddoExtremeQ"][1]);
        setfddoExtremeQ3(formData["fddoExtremeQ"][2]);
        setfddoExtremeQ4(formData["fddoExtremeQ"][3]);

        setfddoFusedQ1(formData["fddoFusedQ"][0]);
        setfddoFusedQ2(formData["fddoFusedQ"][1]);
        setfddoFusedQ3(formData["fddoFusedQ"][2]);
        setfddoFusedQ4(formData["fddoFusedQ"][3]);

        setfddoSingleQ1(formData["fddoSingleQ"][0]);
        setfddoSingleQ2(formData["fddoSingleQ"][1]);
        setfddoSingleQ3(formData["fddoSingleQ"][2]);
        setfddoSingleQ4(formData["fddoSingleQ"][3]);

        setfddoExcessQ1(formData["fddoExcessQ"][0]);
        setfddoExcessQ2(formData["fddoExcessQ"][1]);
        setfddoExcessQ3(formData["fddoExcessQ"][2]);
        setfddoExcessQ4(formData["fddoExcessQ"][3]);

        setfddoMissoutQ1(formData["fddoMissoutQ"][0]);
        setfddoMissoutQ2(formData["fddoMissoutQ"][1]);
        setfddoMissoutQ3(formData["fddoMissoutQ"][2]);
        setfddoMissoutQ4(formData["fddoMissoutQ"][3]);

        setfddoLate3to5Q1(formData["fddoLate3to5Q"][0]);
        setfddoLate3to5Q2(formData["fddoLate3to5Q"][1]);
        setfddoLate3to5Q3(formData["fddoLate3to5Q"][2]);
        setfddoLate3to5Q4(formData["fddoLate3to5Q"][3]);

        setfddoNonFollowingQ1(formData["fddoNonFollowingQ"][0]);
        setfddoNonFollowingQ2(formData["fddoNonFollowingQ"][1]);
        setfddoNonFollowingQ3(formData["fddoNonFollowingQ"][2]);
        setfddoNonFollowingQ4(formData["fddoNonFollowingQ"][3]);

        setfddoNoMarkQ1(formData["fddoNoMarkQ"][0]);
        setfddoNoMarkQ2(formData["fddoNoMarkQ"][1]);
        setfddoNoMarkQ3(formData["fddoNoMarkQ"][2]);
        setfddoNoMarkQ4(formData["fddoNoMarkQ"][3]);

        setbskTotalSamplesQ1(formData["bskTotalSamplesQ"][0]);
        setbskTotalSamplesQ2(formData["bskTotalSamplesQ"][1]);
        setbskTotalSamplesQ3(formData["bskTotalSamplesQ"][2]);
        setbskTotalSamplesQ4(formData["bskTotalSamplesQ"][3]);

        setbskLowQ1(formData["bskLowQ"][0]);
        setbskLowQ2(formData["bskLowQ"][1]);
        setbskLowQ3(formData["bskLowQ"][2]);
        setbskLowQ4(formData["bskLowQ"][3]);

        setbskNoPonyQ1(formData["bskNoPonyQ"][0]);
        setbskNoPonyQ2(formData["bskNoPonyQ"][1]);
        setbskNoPonyQ3(formData["bskNoPonyQ"][2]);
        setbskNoPonyQ4(formData["bskNoPonyQ"][3]);

        setbskShortQ1(formData["bskShortQ"][0]);
        setbskShortQ2(formData["bskShortQ"][1]);
        setbskShortQ3(formData["bskShortQ"][2]);
        setbskShortQ4(formData["bskShortQ"][3]);

        setbskLateQ1(formData["bskLateQ"][0]);
        setbskLateQ2(formData["bskLateQ"][1]);
        setbskLateQ3(formData["bskLateQ"][2]);
        setbskLateQ4(formData["bskLateQ"][3]);

        setbskNoPlasticQ1(formData["bskNoPlasticQ"][0]);
        setbskNoPlasticQ2(formData["bskNoPlasticQ"][1]);
        setbskNoPlasticQ3(formData["bskNoPlasticQ"][2]);
        setbskNoPlasticQ4(formData["bskNoPlasticQ"][3]);

        setbskImproperQ1(formData["bskImproperQ"][0]);
        setbskImproperQ2(formData["bskImproperQ"][1]);
        setbskImproperQ3(formData["bskImproperQ"][2]);
        setbskImproperQ4(formData["bskImproperQ"][3]);

        setbskIncompleteQ1(formData["bskIncompleteQ"][0]);
        setbskIncompleteQ2(formData["bskIncompleteQ"][1]);
        setbskIncompleteQ3(formData["bskIncompleteQ"][2]);
        setbskIncompleteQ4(formData["bskIncompleteQ"][3]);

        setbskNoSunburnQ1(formData["bskNoSunburnQ"][0]);
        setbskNoSunburnQ2(formData["bskNoSunburnQ"][1]);
        setbskNoSunburnQ3(formData["bskNoSunburnQ"][2]);
        setbskNoSunburnQ4(formData["bskNoSunburnQ"][3]);

        setleafTotalSamplesQ1(formData["leafTotalSamplesQ"][0]);
        setleafTotalSamplesQ2(formData["leafTotalSamplesQ"][1]);
        setleafTotalSamplesQ3(formData["leafTotalSamplesQ"][2]);
        setleafTotalSamplesQ4(formData["leafTotalSamplesQ"][3]);

        setleafMissoutQ1(formData["leafMissoutQ"][0]);
        setleafMissoutQ2(formData["leafMissoutQ"][1]);
        setleafMissoutQ3(formData["leafMissoutQ"][2]);
        setleafMissoutQ4(formData["leafMissoutQ"][3]);

        setleafLateQ1(formData["leafLateQ"][0]);
        setleafLateQ2(formData["leafLateQ"][1]);
        setleafLateQ3(formData["leafLateQ"][2]);
        setleafLateQ4(formData["leafLateQ"][3]);

        setleafOverQ1(formData["leafOverQ"][0]);
        setleafOverQ2(formData["leafOverQ"][1]);
        setleafOverQ3(formData["leafOverQ"][2]);
        setleafOverQ4(formData["leafOverQ"][3]);

        setleafNonQ1(formData["leafNonQ"][0]);
        setleafNonQ2(formData["leafNonQ"][1]);
        setleafNonQ3(formData["leafNonQ"][2]);
        setleafNonQ4(formData["leafNonQ"][3]);
      }
    },
    [formData]
  );
      ...
      <Container>
        <Form onSubmit={handleSubmit}>
          <Row className="justify-content-center">
            <Col xs={10}>
              ...
              <Modal show={showModal} onHide={handleCloseModal}>
                <Modal.Body>really want to go back?</Modal.Body>
                <Modal.Footer>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        <Form.Control
                          type="number"
                          value={bbLateInstallationQ1}
                          onChange={handlebbLateInstallationQ1}
                          required
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        <Form.Control
                          type="number"
                          value={bbLateInstallationQ2}
                          onChange={handlebbLateInstallationQ2}
                          required
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        <Form.Control
                          type="number"
                          value={bbLateInstallationQ3}
                          onChange={handlebbLateInstallationQ3}
                          required
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        <Form.Control
                          type="number"
                          value={bbLateInstallationQ4}
                          onChange={handlebbLateInstallationQ4}
                          required
                          placeholder="Q4"
                        />
                      </Col>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={bbLateRetrievalQ1}
                          onChange={handlebbLateRetrievalQ1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bbLateRetrievalQ2}
                          onChange={handlebbLateRetrievalQ2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bbLateRetrievalQ3}
                          onChange={handlebbLateRetrievalQ3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bbLateRetrievalQ4}
                          onChange={handlebbLateRetrievalQ4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={bbImproperInstallQ1}
                          onChange={handlebbImproperInstallQ1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bbImproperInstallQ2}
                          onChange={handlebbImproperInstallQ2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bbImproperInstallQ3}
                          onChange={handlebbImproperInstallQ3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bbImproperInstallQ4}
                          onChange={handlebbImproperInstallQ4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={bbTotalSamplesQ1}
                          onChange={handlebbTotalSamplesQ1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bbTotalSamplesQ2}
                          onChange={handlebbTotalSamplesQ2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bbTotalSamplesQ3}
                          onChange={handlebbTotalSamplesQ3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bbTotalSamplesQ4}
                          onChange={handlebbTotalSamplesQ4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
          ...
          <Row className="justify-content-center">
            <Col xs={10}>
              ...
              <Accordion>
                <Accordion.Item eventKey="0">
                  <Accordion.Header>
                    Improper Installation (Lose and Positioning)
                  </Accordion.Header>
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={pgTotalSamplesQ1}
                          onChange={handlepgTotalSamplesQ1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={pgTotalSamplesQ2}
                          onChange={handlepgTotalSamplesQ2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={pgTotalSamplesQ3}
                          onChange={handlepgTotalSamplesQ3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={pgTotalSamplesQ4}
                          onChange={handlepgTotalSamplesQ4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
          ...
          <Row className="justify-content-center ps-3 pe-3">
            ...
            >
              <h6>{Math.round(pgLate + pgMissout + pgImproper)}%</h6>
            </Col>
          </Row>
          {/* ===================== */}
          {/* END, PROPPING/ GUYING */}
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={bsUndercycleQ1}
                          onChange={handlebsUndercycleQ1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bsUndercycleQ2}
                          onChange={handlebsUndercycleQ2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bsUndercycleQ3}
                          onChange={handlebsUndercycleQ3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bsUndercycleQ4}
                          onChange={handlebsUndercycleQ4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={bsTotalSamplesQ1}
                          onChange={handlebsTotalSamplesQ1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bsTotalSamplesQ2}
                          onChange={handlebsTotalSamplesQ2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bsTotalSamplesQ3}
                          onChange={handlebsTotalSamplesQ3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bsTotalSamplesQ4}
                          onChange={handlebsTotalSamplesQ4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
          ...
          <Row className="justify-content-center ps-3 pe-3">
            ...
            >
              <h6>
                {Math.round(bsMissout + bsBunch + bsUndercycle + bsNoMark)}%
              </h6>
            </Col>
          </Row>
          {/* ================ */}
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        <Form.Control
                          type="number"
                          value={fddoLateFirstQ1}
                          onChange={handlefddoLateFirstQ1}
                          required
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        <Form.Control
                          type="number"
                          value={fddoLateFirstQ2}
                          onChange={handlefddoLateFirstQ2}
                          required
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        <Form.Control
                          type="number"
                          value={fddoLateFirstQ3}
                          onChange={handlefddoLateFirstQ3}
                          required
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        <Form.Control
                          type="number"
                          value={fddoLateFirstQ4}
                          onChange={handlefddoLateFirstQ4}
                          required
                          placeholder="Q4"
                        />
                      </Col>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoLateFinalQ1}
                          onChange={handlefddoLateFinalQ1}
                          type="number"
                          placeholder="Q1"
                          required
                        />
                      ...
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoLateFinalQ2}
                          onChange={handlefddoLateFinalQ2}
                          type="number"
                          placeholder="Q2"
                          required
                        />
                      ...
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoLateFinalQ3}
                          onChange={handlefddoLateFinalQ3}
                          type="number"
                          placeholder="Q3"
                          required
                        />
                      ...
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoLateFinalQ4}
                          onChange={handlefddoLateFinalQ4}
                          type="number"
                          placeholder="Q4"
                          required
                        />
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoImproperQ1}
                          onChange={handlefddoImproperQ1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoImproperQ2}
                          onChange={handlefddoImproperQ2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoImproperQ3}
                          onChange={handlefddoImproperQ3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoImproperQ4}
                          onChange={handlefddoImproperQ4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoLate3to5Q1}
                          onChange={handlefddoLate3to5Q1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoLate3to5Q2}
                          onChange={handlefddoLate3to5Q2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoLate3to5Q3}
                          onChange={handlefddoLate3to5Q3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoLate3to5Q4}
                          onChange={handlefddoLate3to5Q4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoNonFollowingQ1}
                          onChange={handlefddoNonFollowingQ1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoNonFollowingQ2}
                          onChange={handlefddoNonFollowingQ2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoNonFollowingQ3}
                          onChange={handlefddoNonFollowingQ3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoNonFollowingQ4}
                          onChange={handlefddoNonFollowingQ4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoTotalSamplesQ1}
                          onChange={handlefddoTotalSamplesQ1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoTotalSamplesQ2}
                          onChange={handlefddoTotalSamplesQ2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoTotalSamplesQ3}
                          onChange={handlefddoTotalSamplesQ3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={fddoTotalSamplesQ4}
                          onChange={handlefddoTotalSamplesQ4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskNoPlasticQ1}
                          onChange={handlebskNoPlasticQ1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskNoPlasticQ2}
                          onChange={handlebskNoPlasticQ2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskNoPlasticQ3}
                          onChange={handlebskNoPlasticQ3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskNoPlasticQ4}
                          onChange={handlebskNoPlasticQ4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskIncompleteQ1}
                          onChange={handlebskIncompleteQ1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskIncompleteQ2}
                          onChange={handlebskIncompleteQ2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskIncompleteQ3}
                          onChange={handlebskIncompleteQ3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskIncompleteQ4}
                          onChange={handlebskIncompleteQ4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskNoSunburnQ1}
                          onChange={handlebskNoSunburnQ1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskNoSunburnQ2}
                          onChange={handlebskNoSunburnQ2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskNoSunburnQ3}
                          onChange={handlebskNoSunburnQ3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskNoSunburnQ4}
                          onChange={handlebskNoSunburnQ4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskTotalSamplesQ1}
                          onChange={handlebskTotalSamplesQ1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskTotalSamplesQ2}
                          onChange={handlebskTotalSamplesQ2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskTotalSamplesQ3}
                          onChange={handlebskTotalSamplesQ3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={bskTotalSamplesQ4}
                          onChange={handlebskTotalSamplesQ4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
                  ...
                  <Accordion.Body>
                    <Row className="justify-content-center">
                      <Col>
                        {" "}
                        <Form.Control
                          value={leafTotalSamplesQ1}
                          onChange={handleleafTotalSamplesQ1}
                          type="number"
                          placeholder="Q1"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={leafTotalSamplesQ2}
                          onChange={handleleafTotalSamplesQ2}
                          type="number"
                          placeholder="Q2"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={leafTotalSamplesQ3}
                          onChange={handleleafTotalSamplesQ3}
                          type="number"
                          placeholder="Q3"
                        />
                      </Col>
                      <Col>
                        {" "}
                        <Form.Control
                          value={leafTotalSamplesQ4}
                          onChange={handleleafTotalSamplesQ4}
                          type="number"
                          placeholder="Q4"
                        />
                      </Col>
          ...
          <Row className="justify-content-center ps-3 pe-3">
            ...
            >
              <h6>
                {Math.round(leafMissout + leafLate + leafOver + leafNon)}%
              </h6>
            </Col>
          </Row>
          {/* ================== */}
