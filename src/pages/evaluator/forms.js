     ...
     <Container>
       ...
       <Row className="justify-content-center">
		 <Col xs={8} className="p-0 mb-2">
			 <div style={{cursor:"pointer"}} className="d-inline">
			    ...
			    <span onClick={handleClickCreateForm} className="ms-2 fs-4">Create Form</span>
			 </div>
		 </Col>  
